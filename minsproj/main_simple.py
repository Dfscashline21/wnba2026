"""
WNBA Minutes Prediction Model - Simplified Demo
...
def run_simple_demo():
    ...
    try:
        ...
        for i, player in enumerate(las_players[:8], 1):
            ...
            confidence_icon = "✅" if player['confidence'] > 0.7 else "⚠️"
        ...
        print("="*60)
        print("\n✅ This demonstrates core prediction logic")
        print("📋 For full system with ML models, run: python install.py")
...
def main():
    ...
    if not check_required_imports():
        print("\n💡 Try running: pip install pandas numpy scikit-learn requests")
        return False
