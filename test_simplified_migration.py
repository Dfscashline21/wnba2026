# -*- coding: utf-8 -*-
"""
Test the simplified migration script with REST API
"""

import sys
import traceback

print("🧪 Testing simplified migration script with REST API...")
print("=" * 50)

try:
    # Test importing the simplified migration script
    print("📋 Testing migration script import...")
    from supabase_migration_rest import SupabaseMigration
    ...
    print("\n" + "=" * 50)
    print("🎉 SIMPLIFIED MIGRATION SCRIPT TEST COMPLETED!")
    print("=" * 50)
    ...
    print("   python supabase_migration_rest.py")
