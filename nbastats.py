...
def get_schedule():
    ...
    gamesched = 'https://data.wnba.com/data/5s/v2015/json/mobile_teams/wnba/2025/league/10_full_schedule_tbds.json'
    ...
    # today = fullschedule[pd.to_datetime(fullschedule['gdte']) ==  str(todaysdate)].reset_index()
    today = fullschedule[pd.to_datetime(fullschedule['gdte']) ==  '2025-09-14'].reset_index()
...
def player_pos():
    ...
    player_position_table = pd.read_csv('playerposition.csv')
