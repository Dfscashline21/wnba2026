# -*- coding: utf-8 -*-
"""
Test the final fixed Supabase connection
"""

import sys
import traceback

print("🧪 Testing final fixed Supabase connection...")
print("=" * 50)

try:
    # Test importing the final module
    print("📋 Testing module import...")
    from supabase_conn_final import supabase_conn, get_supabase_engine
