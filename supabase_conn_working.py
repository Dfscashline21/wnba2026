# -*- coding: utf-8 -*-
"""
Supabase connection module for NBA data pipeline
Replaces db_conn.py with Supabase integration (Engine only)
Uses 'nba' schema (WNBA uses 'wnba' schema - no overlap)
...
class SupabaseConnection:
    """Supabase connection manager for NBA data pipeline (Engine only)"""
    ...
    def __init__(self):
        ...
        self.schema = "nba"  # NBA uses 'nba' schema, WNBA uses 'wnba' schema
        ...
        self._engine = None
        logger.info("✅ Supabase connection initialized for NBA (engine only)")
    ...
    def upload_dataframe(self, df: pd.DataFrame, table_name: str, schema: str = "nba", 
        ...
        Args:
            ...
            schema: Database schema (default: nba)
    ...
    def insert_data(self, table_name: str, data: dict, schema: str = "nba") -> bool:
        """
    ...
    def batch_insert(self, table_name: str, data_list: list, schema: str = "nba") -> bool:
        """
    ...
    def get_table_data(self, table_name: str, schema: str = "nba", 
