...
def main():
    ...
    if minutesprojected == "Y":
        print("📂 Loading projected minutes from CSV...")
        minutes = pd.read_csv('mincheckproj.csv',encoding = 'latin-1')
    else:
        print("🌐 Pulling current minutes from Roto...")
        minutes = rp.rotomins()
    ...
    # Solution 2: Set DBT environment variables for cloud environment
    try:
