...
-- Analysis: Trend-Based Prediction Accuracy Evaluation for STANDARD Odds
-- This analysis evaluates the accuracy of trend-based prop predictions for standard odds
...
overall_summary AS (
    SELECT 
        'OVERALL' as category,
        'All Standard Predictions' as subcategory,
        COUNT(*) as total_predictions,
...
top_players AS (
    ...
    HAVING COUNT(*) >= 5  -- Minimum 5 predictions for standard
