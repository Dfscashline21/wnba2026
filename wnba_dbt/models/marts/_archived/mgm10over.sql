...
with overs as (select *
            ...
            ,"Assists", sum("Assists Over")/10 ::float as astover,"Points",sum("Points Over")/10 ::float as pointsover
            ,"Rebounds",sum("Rebounds Over")/10 ::float as rebover
            from overs
            where game_number <=10 and overs.player is not null and overs."date"::date = current_date
