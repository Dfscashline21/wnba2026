...
-- Analysis: Trend-Based Prediction Accuracy Evaluation for DEMON Odds
-- This analysis evaluates the accuracy of trend-based prop predictions for demon odds
...
overall_summary AS (
    SELECT 
        'OVERALL' as category,
        'All Demon Predictions' as subcategory,
        COUNT(*) as total_predictions,
...
top_players AS (
    ...
    HAVING COUNT(*) >= 3  -- Minimum 3 predictions for demon
