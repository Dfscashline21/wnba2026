# -*- coding: utf-8 -*-
"""
Test the database-only Supabase connection
"""

import sys
import traceback

print("🧪 Testing database-only Supabase connection...")
print("=" * 50)

try:
    # Test importing the database-only module
    print("📋 Testing module import...")
    from supabase_conn_db_only import supabase_conn, get_supabase_engine
